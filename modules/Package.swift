...
//        .package(url: "https://github.com/zcash/zcash-swift-wallet-sdk", branch: "migrate_build"),
        .package(url: "git@github.com:zcash/zcash-swift-wallet-sdk.git", branch: "migrate_build"),
