...
let package = Package(
    ...
    products: [
        ...
        .library(name: "ResyncWallet", targets: ["ResyncWallet"]),
...
//        .package(url: "https://github.com/Electric-Coin-Company/zcash-swift-wallet-sdk", from: "2.4.0"),
        .package(url: "https://github.com/Electric-Coin-Company/zcash-swift-wallet-sdk", branch: "db-debug-custom-functions"),
//        .package(url: "https://github.com/LukasKorba/ZcashLightClientKit", branch: "1614-Get-a-time-for-a-blockheight"),
    ...
    targets: [
        ...
        .target(
            ...
            path: "Sources/Features/ResyncWallet"
        ),
        .target(
            name: "Root",
            dependencies: [
